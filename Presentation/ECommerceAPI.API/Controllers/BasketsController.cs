...
namespace ECommerceAPI.API.Controllers
{
    ...
    public class BasketsController : ControllerBase
    {
        ...
        [HttpGet]
        [AuthorizeDefinition(Controller = AuthorizeDefinitionConstants.Baskets, ActionType = ActionType.Reading, Definition = "Get Basket Items")]
        ...
        [HttpPost]
        [AuthorizeDefinition(Controller = AuthorizeDefinitionConstants.Baskets, ActionType = ActionType.Writing, Definition = "Add Item To Basket")]
        ...
        [HttpPut]
        [AuthorizeDefinition(Controller = AuthorizeDefinitionConstants.Baskets, ActionType = ActionType.Updating, Definition = "Update Quantity")]
        ...
        [AuthorizeDefinition(Controller = AuthorizeDefinitionConstants.Baskets, ActionType = ActionType.Deleting, Definition = "Remove Basket Item")]
